...
/**
 * Unit tests for LlmActor JSON-parsing helpers.
 */
class LlmActorTest {
    ...
    void extractJsonStringField_japaneseValueExtracted() {
        ...
        assertThat(LlmActor.extractJsonStringField(json, "prompt")).isEqualTo("SPIFFEは有効？");
    }

    @Test
    void extractJsonStringField_unicodeEscapeInPromptDecoded() {
        String json = "{\"prompt\":\"\\u30c6\\u30b9\\u30c8\"}";
        assertThat(LlmActor.extractJsonStringField(json, "prompt")).isEqualTo("テスト");
    }

    @Test
    void extractJsonStringField_newlinesInPromptDecoded() {
        String json = "{\"prompt\":\"line1\\nline2\"}";
        assertThat(LlmActor.extractJsonStringField(json, "prompt")).isEqualTo("line1\nline2");
    }
}
