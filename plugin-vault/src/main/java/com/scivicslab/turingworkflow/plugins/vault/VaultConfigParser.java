...
public class VaultConfigParser {
     ...
     *
     * <p>Paths are resolved with the following priority order (highest to lowest):
     * host-specific &gt; group-specific &gt; global.</p>
     */
    public static class VaultPaths {

        /** Paths defined in the {@code [vault:all]} section (lowest priority). */
        private final Map<String, String> globalPaths = new HashMap<>();

        /** Paths defined in {@code [vault:<groupName>]} sections (medium priority). */
        private final Map<String, Map<String, String>> groupPaths = new HashMap<>();

        /** Paths defined in {@code [vault:host:<hostname>]} sections (highest priority). */
