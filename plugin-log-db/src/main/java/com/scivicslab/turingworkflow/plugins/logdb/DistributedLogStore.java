 ...
 * at workflow startup and cleared after execution.</p>
 *
...
public interface DistributedLogStore extends AutoCloseable {
    ...
    /**
     * Internal holder for the singleton {@link DistributedLogStore} instance.
     *
     * <p>Uses the initialization-on-demand holder pattern for thread-safe
     * lazy singleton access.</p>
     */
    class InstanceHolder {
        /** The global singleton instance, set at workflow startup. */
     ...
     *
     * <p>Called when starting workflow execution.</p>
     *
     ...
     * by the store and will be closed when execution ends.</p>
     *
     ...
     * @param commandLine the command line used to invoke the workflow
     * @param pluginVersion plugin version
     * @param pluginCommit plugin git commit hash (may be null)
     * @return session ID for subsequent log entries
     */
