 ...
 * </ul>
 */
public class FineWebSearchActor extends IIActorRef<FineWebSearchActor> {

    private static final Logger logger = Logger.getLogger(FineWebSearchActor.class.getName());
